...
abstract class Controller
{
    ...
    protected static function isGet()
    {
        if ($_SERVER ['REQUEST_METHOD'] !== 'GET')
             throw new Exception("O método de requisão deve ser  GET");
    }
    ...
    {   
        ...
        throw new Exception(
            "o metodo de requisição deve ser POST");
    ...
    protected static function getStringFromUrl($var_get, $var_name) : string
    {
        self::isGet();
